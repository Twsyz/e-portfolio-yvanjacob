...
const translations = {
  fr: {
    ...
    project_title: "Projet : Réduction des Déchets Plastiques",
    meta_objectives: "Objectifs",
    meta_objectives_desc: "Réduire de 30% la consommation de plastique à usage unique sur le campus universitaire.",
    meta_team: "Équipe",
    meta_team_desc: "6 étudiants - INP Toulouse<br>Modules : Coordination, Communication, Logistique",
    meta_duration: "Durée",
    meta_duration_desc: "6 mois (Janvier - Juin 2024)<br>Pitch : 3 minutes",
    odd_title: "ODD de l'UNESCO ciblés",
    odd_6_title: "Eau propre et assainissement",
    odd_6_desc: "Réduction de la pollution plastique dans les ressources en eau.",
    odd_11_title: "Villes et communautés durables",
    odd_11_desc: "Campus universitaire plus propre et écoresponsable.",
    odd_12_title: "Consommation responsable",
    odd_12_desc: "Promotion des alternatives réutilisables au plastique.",
    odd_14_title: "Vie aquatique",
    odd_14_desc: "Prévention de la pollution plastique dans les écosystèmes aquatiques.",
    impact_title: "Impact mesuré",
    impact_waste: "Déchets plastiques",
    impact_points: "Points de collecte",
  ...
  en: {
    ...
    project_title: "Project: Plastic Waste Reduction",
    meta_objectives: "Objectives",
    meta_objectives_desc: "Reduce single-use plastic consumption by 30% on university campus.",
    meta_team: "Team",
    meta_team_desc: "6 students - INP Toulouse<br>Roles: Coordination, Communication, Logistics",
    meta_duration: "Duration",
    meta_duration_desc: "6 months (January - June 2024)<br>Pitch: 3 minutes",
    odd_title: "UNESCO SDGs targeted",
    odd_6_title: "Clean water and sanitation",
    odd_6_desc: "Reduction of plastic pollution in water resources.",
    odd_11_title: "Sustainable cities and communities",
    odd_11_desc: "Cleaner and eco-friendly university campus.",
    odd_12_title: "Responsible consumption",
    odd_12_desc: "Promotion of reusable alternatives to plastic.",
    odd_14_title: "Life below water",
    odd_14_desc: "Prevention of plastic pollution in aquatic ecosystems.",
    impact_title: "Measured impact",
    impact_waste: "Plastic waste",
    impact_points: "Collection points",
    impact_people: "People reached",
    impact_workshops: "Workshops organized",
    context_title: "CAM module context",
    context_desc: "This project was developed as part of module 2 'Civic Engagement & Sustainable Development Goals'. The objective was to create a civic engagement proposal aligned with at least 3 UNESCO SDGs, presented as an A4 infographic and a 3-minute pitch."
  ...
  es: {
    ...
    sd_subtitle: "Propuestas de compromiso cívico alineadas con los Objetivos de Desarrollo Sostenible de la UNESCO",
    pdf_view: "📄 Ver imagen completa",
    pdf_download: "⬇️ Descargar",
    pdf_note: "Infografía A4 retrato",
    project_title: "Proyecto: Reducción de Residuos Plásticos",
    meta_objectives: "Objetivos",
    meta_objectives_desc: "Reducir en 30% el consumo de plástico de un solo uso en el campus universitario.",
    meta_team: "Equipo",
    meta_team_desc: "6 estudiantes - INP Toulouse<br>Módulos: Coordinación, Comunicación, Logística",
    meta_duration: "Duración",
    meta_duration_desc: "6 meses (Enero - Junio 2024)<br>Presentación: 3 minutos",
    odd_title: "ODS de la UNESCO objetivos",
    odd_6_title: "Agua limpia y saneamiento",
    odd_6_desc: "Reducción de la contaminación plástica en recursos hídricos.",
    odd_11_title: "Ciudades y comunidades sostenibles",
    odd_11_desc: "Campus universitario más limpio y ecológico.",
    odd_12_title: "Consumo responsable",
    odd_12_desc: "Promoción de alternativas reutilizables al plástico.",
    odd_14_title: "Vida submarina",
    odd_14_desc: "Prevención de la contaminación plástica en ecosistemas acuáticos.",
    impact_title: "Impacto medido",
    impact_waste: "Residuos plásticos",
    ...
    context_desc: "Este proyecto fue desarrollado en el marco del módulo 2 'Compromiso Cívico y Objetivos de Desarrollo Sostenible'. El objetivo era crear una propuesta de compromiso cívico alineada con al menos 3 ODS de la UNESCO, presentada como infografía A4 y una presentación de 3 minutos."
  ...
  cn: {
    ...
    pdf_download: "⬇️ 下载",
    pdf_note: "A4竖版信息图表 ",
    project_title: "项目：塑料废物减少",
    meta_objectives: "目标",
    meta_objectives_desc: "在大学校园减少30%一次性塑料使用。",
    meta_team: "团队",
    meta_team_desc: "6名学生 - 图卢兹INP<br>角色：协调、沟通、物流",
    meta_duration: "时长",
    meta_duration_desc: "6个月（1月-6月 2024）<br>演讲：3分钟",
    odd_title: "联合国教科文组织目标SDGs",
    odd_6_title: "清洁饮水和卫生设施",
    odd_6_desc: "减少水资源中的塑料污染。",
    odd_11_title: "可持续城市和社区",
    odd_11_desc: "更清洁环保的大学校园。",
    odd_12_title: "负责任消费",
    odd_12_desc: "推广可重复使用的塑料替代品。",
    odd_14_title: "水下生物",
    odd_14_desc: "防止水生生态系统中的塑料污染。",
    impact_title: "测量影响",
    impact_waste: "塑料废物",
    impact_points: "收集点",
    impact_people: "触及人员",
    impact_workshops: "组织研讨会",
    context_title: "CAM模块背景",
    context_desc: "此项目是在模块2'公民参与与可持续发展目标'的框架下开发的。目标是创建一个与至少3个联合国教科文组织SDGs一致的公民参与提案，以A4信息图表和3分钟演讲形式呈现。"
