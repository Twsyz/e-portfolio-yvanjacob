...
const translations = {
  fr: {
    ...
    ingenieur_toolhead_text: "Conception d'une tête d'impression 3D pour un projet de fin d'études, incluant la modélisation 3D, la simulation et l'assemblage mécanique.",
    ingenieur_3Dprintshop_title: "Design et programmation d'une boutique d'impression 3D",
    ingenieur_3Dprintshop_text: "Développement d'une boutique d'impression 3D automatisée, intégrant la gestion des commandes, la préparation des fichiers d'impression et l'optimisation du processus de production.(En cours)",
